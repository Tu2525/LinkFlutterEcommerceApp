                ...
                children: [
                    ...
                    child: CustomTextForm(
                      ...
                      onChanged: (value) {
                       WidgetsBinding.instance.addPostFrameCallback((_) {
                          ref.read(nameTextProvider.notifier).state = value;
                        });
                      },
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: CustomTextForm(
                      ...
                      onChanged: (value) {
                        WidgetsBinding.instance.addPostFrameCallback((_) {
                          ref.read(cardNumberTextProvider.notifier).state = value;
                        });
                      },
                    ),
                  ),
                              ...
                              child: CustomTextForm(
                                ...
                                onChanged: (value) {
                                 WidgetsBinding.instance.addPostFrameCallback((
                                    ...
                                    ref
                                        .read(expiryTextProvider.notifier)
                                        .state = value;
                                  });
                                },
                              ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: CustomTextForm(
                        ...
                        onChanged: (value) {
                          WidgetsBinding.instance.addPostFrameCallback((_) {
                            ref.read(nameTextProvider.notifier).state =
                                value;
                          });
                        },
                      ),
                    ...
                    Padding(
                      ...
                      child: CustomTextForm(
                        ...
                        onChanged: (value) {
                         WidgetsBinding.instance.addPostFrameCallback((_) {
                            ref.read(cardNumberTextProvider.notifier).state =
                                value;
                          });
                        },
                      ),
